...
4. Prometheus AlertManager 通过 webhook 推送到 mogo，再由 mogo 分发到钉钉

## 集群部署

可参考[https://github.com/shimohq/mogo/tree/master/data/k8s/prometheus](https://github.com/shimohq/mogo/tree/master/data/k8s/prometheus) 中的配置。
...
告警方式为 webhook，回调到 mogo 服务，修改 url 地址，保证可以正常访问 mogo 服务。
...
- name: 'webhook'
  webhook_configs:
  - url: 'http://mogo:9001/api/v1/prometheus/alerts'
```
